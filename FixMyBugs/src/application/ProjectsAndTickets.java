...
public class ProjectsAndTickets {
     ...
     */
    public ProjectsAndTickets(String projectName, LocalDate projectDate, String projectDescription) {
        this.projectName = projectName;
        this.projectDate = projectDate;
        this.projectDescription = projectDescription;
    }

     public ProjectsAndTickets(String projects, String ticketName, String ticketDescription) {
